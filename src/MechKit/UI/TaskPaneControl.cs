...
namespace MechKit.UI
{
    ...
    internal sealed class TaskPaneControl : UserControl
    {
            ...
            SolidWorks.Interop.sldworks.ModelDoc2 doc, PartListOptions options)
        {
            ...
            quick.Naming.MachinedSegmentBomNameFlags = options.Naming.MachinedSegmentBomNameFlags;
            quick.Naming.MachinedMaterialProcessPresets = options.Naming.MachinedMaterialProcessPresets;
